...
d_meta_or_c19 <- read.csv("data_odds_ratios/meta_preg_coefs_overall_c19.csv")
d_meta_or_flu <- read.csv("data_odds_ratios/meta_preg_coefs_overall_flu.csv")
...
write_csv(
  d_meta_or_pretty,
  file = "data_odds_ratios/meta_preg_coefs_overall_pretty.csv"
  )
