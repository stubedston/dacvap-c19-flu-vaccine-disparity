...
qload(s_drive("m_log_q0_pregnant.qsm"))
qload(s_drive("m_log_by_wimd_preg.qsm"))
qload(s_drive("d_describe_pregnant.qsm"))
d_describe <- d_describe_imputed_preg
xvar_names <- qread(s_drive("xvar_names.qs"))
xvar_names <- xvar_names[-3]
...
qsavem(
    ...
    p_coef_compare_q1q5,
    t_model_stats,
    file = "results/coef_pregnant.qsm"
)
cat("Done!\n")
beep(0)