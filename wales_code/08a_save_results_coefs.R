...
qload(file = "results/coef.qsm")
qload(file = "results/interactions.qsm")
xvar_names <- qread(file = s_drive("xvar_names.qs"))
xlbl_lkp <- qread(s_drive("xlbl_lkp.qs"))
...
overall_coefs <- rbind(
	...
	coefs_gndr_cd_c19_unadj_overall,
	...
	coefs_gndr_cd_flu_unadj_overall,
...
write.csv(overall_coefs, "results/main_analysis/export_coefs/overall_coefs.csv", row.names = FALSE)
write.csv(q1_coefs, "results/main_analysis/export_coefs/q1_coefs.csv", row.names = FALSE)
write.csv(q2_coefs, "results/main_analysis/export_coefs/q2_coefs.csv", row.names = FALSE)
write.csv(q3_coefs, "results/main_analysis/export_coefs/q3_coefs.csv", row.names = FALSE)
write.csv(q4_coefs, "results/main_analysis/export_coefs/q4_coefs.csv", row.names = FALSE)
write.csv(q5_coefs, "results/main_analysis/export_coefs/q5_coefs.csv", row.names = FALSE)
write.csv(interaction_coefs, "results/main_analysis/export_coefs/interaction_coefs.csv", row.names = FALSE)
