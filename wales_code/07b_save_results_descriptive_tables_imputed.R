...
d_describe <- d_describe_imputed[,1:9]
d_log_alfs <- impute.bmi(d_log_alfs)
d_log_wimd_q1_alfs <- impute.bmi(d_log_wimd_q1_alfs)
d_log_wimd_q2_alfs <- impute.bmi(d_log_wimd_q2_alfs)
d_log_wimd_q3_alfs <- impute.bmi(d_log_wimd_q3_alfs)
d_log_wimd_q4_alfs <- impute.bmi(d_log_wimd_q4_alfs)
d_log_wimd_q5_alfs <- impute.bmi(d_log_wimd_q5_alfs)
...
write.csv(overall_descriptive, "results/main_analysis/export_descriptive/imputed_overall_descriptive.csv", row.names = FALSE)
write.csv(q1_descriptive, "results/main_analysis/export_descriptive/imputed_q1_descriptive.csv", row.names = FALSE)
write.csv(q2_descriptive, "results/main_analysis/export_descriptive/imputed_q2_descriptive.csv", row.names = FALSE)
write.csv(q3_descriptive, "results/main_analysis/export_descriptive/imputed_q3_descriptive.csv", row.names = FALSE)
write.csv(q4_descriptive, "results/main_analysis/export_descriptive/imputed_q4_descriptive.csv", row.names = FALSE)
write.csv(q5_descriptive, "results/main_analysis/export_descriptive/imputed_q5_descriptive.csv", row.names = FALSE)
...
qsavem(
	...
	clinical_conditions_descriptive_q5,
	health_board_descriptive_q5,
    file = s_drive("descriptive_tables_imputed_final.qsm")
)
